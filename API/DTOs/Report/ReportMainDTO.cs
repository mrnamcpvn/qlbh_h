...
namespace API.DTOs.Report
{
    ...
    {
        public int Tong_SoLuongTonDau { get; set; }
        public decimal Tong_GiaTon { get; set; }
        public int Tong_SoLuongNhap { get; set; }
        public decimal Tong_TongTienNhap { get; set; }
        public int Tong_SoLuongXuat { get; set; }
        public decimal Tong_TongTienXuat { get; set; }
        public int Tong_SoLuongTonCuoi { get; set; }
